plugins {
    ...
    alias(libs.plugins.jetbrains.kotlin.android) // Aquí aplicas el plugin de Kotlin
    id("kotlin-android")
    id("kotlin-kapt") // Esta línea está bien, es para el procesamiento de anotaciones de Kotlin
}

android {
    namespace = "com.example.casofuturo039"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.casofuturo039"
        minSdk = 27
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
